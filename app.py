...
def pred():
    if 'resume' in request.files:
        ...
        return render_template('resume.html',predicted_category=predicted_category,recommended_job=recommended_job,phone=phone,name=name,extracted_skills=extracted_skills,extracted_education=extracted_education,email=email)
    else:
